...
class DietsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $diets->description=' dieta, będąca wariantem diety podstawowej, z której wyeliminowano produkty zawierające gluten, czyli wykluczono produkty spożywcze z dodatkiem naturalnych bądź przetworzonych zbóż[1]:
